...
public class MainActivity extends Activity {
    ...
    @Override public void onCreate(Bundle b){super.onCreate(b);
        ...
        TextView title=new TextView(this);title.setText("Stock Radar v0.5 · 자동추천 14 + 관심종목 + 섹터흐름");title.setTextSize(25);title.setTextColor(Color.rgb(14,53,93));root.addView(title);
        ...
        status=new TextView(this);status.setPadding(0,pad(10),0,pad(10));status.setText("자동추천 TOP 14 · 관심종목 장기점수 · 섹터 상승흐름 · 반등주 차트를 한 앱에서 확인합니다.");root.addView(status);
