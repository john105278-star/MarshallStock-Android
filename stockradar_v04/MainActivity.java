...
public class MainActivity extends Activity {
    ...
    @Override public void onCreate(Bundle b){super.onCreate(b);
        ...
        TextView title=new TextView(this);title.setText("Stock Radar v0.4 · 마샬 패턴 + 반등주 차트");title.setTextSize(25);title.setTextColor(Color.rgb(14,53,93));root.addView(title);
